...
export default function SongLibrary({ scheduleId }: { scheduleId: string }) {
  ...
  return (
    <>
      <div className="p-6 border-b border-slate-300 dark:border-white/5 transition-colors flex flex-col gap-4">
        <div className="flex items-center justify-between">
          ...
          <button 
            ...
            className="text-[10px] text-slate-500 dark:text-zinc-400 hover:text-slate-900 dark:text-slate-100 transition-colors uppercase tracking-widest border border-slate-300 dark:border-white/10 transition-colors px-2 py-1 rounded"
            title="Add New Song"
          >
            + Add
          </button>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-1 pb-20 scrollbar-thin scrollbar-thumb-white/10 hover:scrollbar-thumb-white/20">
        {filtered.map(song => (
          <div 
            key={song.id} 
            draggable
          ...
          >
            <div className="flex justify-between items-start">
              <div className="pr-12">
                 <h3 className="font-medium text-slate-900 dark:text-white text-sm group-hover:text-slate-900 dark:hover:text-slate-100 transition-colors cursor-pointer">{song.title}</h3>
                 <p className="text-[10px] text-slate-500 dark:text-zinc-400 mt-0.5 uppercase tracking-wider">{song.artist}</p>
              </div>
              <span className="font-mono text-[9px] px-1.5 py-0.5 border border-slate-300 dark:border-white/10 transition-colors text-slate-500 dark:text-zinc-400 rounded mt-0.5">
