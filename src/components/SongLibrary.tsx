              ...
              >
                ...
                <div className="absolute right-3 top-3 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    ...
                    className="p-1.5 text-slate-500 dark:text-zinc-400 hover:text-red-400 hover:bg-slate-100 dark:hover:bg-red-400/10 rounded border border-slate-200 dark:border-white/10 bg-white shadow-sm dark:bg-[#1e1e1e] transition-colors"
                    title="Delete"
                  >
